...
class BMIActivity : AppCompatActivity() {
    ...
    private fun makeVisibleMetricUnitsView() {
        ...
        binding?.tillMetricUsUnitHeightFeet?.visibility = View.GONE // make height feet view Gone.
    ...
    private fun makeVisibleUsUnitsView() {
        ...
        binding?.tilMetricUnitHeight?.visibility = View.GONE // METRIC  Height UNITS VIEW is InVisible
        binding?.tilMetricUnitWeight?.visibility = View.GONE // METRIC  Weight UNITS VIEW is InVisible
        binding?.tilUsMetricUnitWeight?.visibility = View.VISIBLE // make weight view visible.
        binding?.tillMetricUsUnitHeightFeet?.visibility = View.VISIBLE // make height feet view visible.
    ...
    private fun calculatgeUnits(){
        if(currentVisibleView == METRIC_UNITS_VIEW){
            ...
            if (validateUsUnits()) {
                ...
                // formula for calculating bmi in pounds and inches
